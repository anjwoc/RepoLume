...
class TestEmbedderConfiguration:
    ...
    def test_embedder_type_detection(self):
        ...
        if current_type == 'ollama':
            ...
            assert is_google and not is_ollama
        else:  # openai
...
class TestEnvironmentVariableHandling:
    ...
    def test_embedder_type_env_var(self, embedder_type=None):
        """Test embedder selection via LOCALWIKI_EMBEDDER_TYPE environment variable."""
        import importlib
        import api.config
    ...
    def _test_single_embedder_type(self, embedder_type):
        ...
        # Save original value
        original_value = os.environ.get('LOCALWIKI_EMBEDDER_TYPE')
        
        try:
            # Set environment variable
            os.environ['LOCALWIKI_EMBEDDER_TYPE'] = embedder_type
            ...
            if original_value is not None:
                os.environ['LOCALWIKI_EMBEDDER_TYPE'] = original_value
            elif 'LOCALWIKI_EMBEDDER_TYPE' in os.environ:
                del os.environ['LOCALWIKI_EMBEDDER_TYPE']
