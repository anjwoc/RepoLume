...
const DEMO_SEQUENCE_CHART = `sequenceDiagram
  participant User
  participant LocalWiki
  participant GitHub

  User->>LocalWiki: Enter repository URL
  LocalWiki->>GitHub: Request repository data
  GitHub-->>LocalWiki: Return repository data
  LocalWiki->>LocalWiki: Process and analyze code
  LocalWiki-->>User: Display wiki with diagrams

  %% Add a note to make text more visible
  Note over User,GitHub: LocalWiki supports sequence diagrams for visualizing interactions`;
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://github.com/localwiki" target="_blank" rel="noopener noreferrer"
